...
# Initialize the Delta Exchange with testnet endpoint
exchange = ccxt.delta({
    'apiKey': api_key,
    'secret': api_secret,
    'enableRateLimit': True,  # Enables rate limit handling
    'urls': {
        'api': 'https://testnet-api.delta.exchange'  # Use the testnet endpoint
    },
    'options': {
